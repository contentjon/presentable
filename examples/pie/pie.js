...
var presentable = {examples:{}};
presentable.examples.pie = {};
presentable.examples.pie.d3 = {};
presentable.examples.pie.d3.selector__GT_name = function(a) {
  return cljs.core.keyword_QMARK_.call(null, a) ? cljs.core.name.call(null, a) : a
};
presentable.examples.pie.d3.select = function() {
  var a = null, b = function(b) {
    return a.call(null, d3, b)
  }, c = function(a, b) {
    return a.select(presentable.examples.pie.d3.selector__GT_name.call(null, b))
  }, a = function(a, e) {
    switch(arguments.length) {
      case 1:
        return b.call(this, a);
...
presentable.examples.pie.d3.select_STAR_ = function() {
  var a = null, b = function(b) {
    return a.call(null, d3, b)
  }, c = function(a, b) {
    return a.selectAll(presentable.examples.pie.d3.selector__GT_name.call(null, b))
  }, a = function(a, e) {
    switch(arguments.length) {
      case 1:
        return b.call(this, a);
...
presentable.examples.pie.d3.attr = function() {
  var a = null, b = function(a) {
    return a.attr()
  }, c = function(a, b) {
    return a.attr(cljs.core.name.call(null, b))
  }, d = function(a, b, c) {
...
presentable.examples.pie.d3.attr_STAR_ = function() {
  var a = function(a, b) {
    for(var e = cljs.core.seq.call(null, cljs.core.partition.call(null, 2, b)), f = null, g = 0, h = 0;;) {
      if(h < g) {
        var i = cljs.core._nth.call(null, f, h), j = cljs.core.nth.call(null, i, 0, null), i = cljs.core.nth.call(null, i, 1, null);
        presentable.examples.pie.d3.attr.call(null, a, j, i);
        h += 1
      }else {
        if(e = cljs.core.seq.call(null, e)) {
          cljs.core.chunked_seq_QMARK_.call(null, e) ? (g = cljs.core.chunk_first.call(null, e), e = cljs.core.chunk_rest.call(null, e), f = g, g = cljs.core.count.call(null, g)) : (g = cljs.core.first.call(null, e), f = cljs.core.nth.call(null, g, 0, null), g = cljs.core.nth.call(null, g, 1, null), presentable.examples.pie.d3.attr.call(null, a, f, g), e = cljs.core.next.call(null, e), f = null, g = 0), h = 0
        }else {
          break
        }
      }
...
presentable.examples.pie.d3.insert = function(a, b, c) {
  return a.insert(cljs.core.name.call(null, b), cljs.core.name.call(null, c))
};
presentable.examples.pie.d3.remove = function(a) {
  return a.remove()
};
presentable.examples.pie.d3.css = function() {
  var a = null, b = function(a, b) {
    return a.style(cljs.core.name.call(null, b))
  }, c = function(a, b, c) {
    return a.style(cljs.core.name.call(null, b), c)
  }, a = function(a, e, f) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, e);
...
presentable.examples.pie.d3.width = function(a) {
  return parseInt(presentable.examples.pie.d3.css.call(null, a, "\ufdd0:width"))
};
presentable.examples.pie.d3.height = function(a) {
  return parseInt(presentable.examples.pie.d3.css.call(null, a, "\ufdd0:height"))
};
presentable.examples.pie.d3.text = function(a, b) {
  return a.text(b)
};
presentable.examples.pie.d3.html = function(a, b) {
  return a.html(b)
};
presentable.examples.pie.d3.Append = {};
presentable.examples.pie.d3.append_impl = function(a, b) {
  var c;
  c = a ? a.presentable$examples$pie$d3$Append$append_impl$arity$2 : a;
  if(c) {
    return a.presentable$examples$pie$d3$Append$append_impl$arity$2(a, b)
  }
  c = presentable.examples.pie.d3.append_impl[goog.typeOf(null == a ? null : a)];
  if(!c && (c = presentable.examples.pie.d3.append_impl._, !c)) {
    throw cljs.core.missing_protocol.call(null, "Append.append-impl", a);
  }
  return c.call(null, a, b)
};
presentable.examples.pie.d3.handle_attrs = function(a, b) {
...
cljs.core.PersistentVector.prototype.presentable$examples$pie$d3$Append$append_impl$arity$2 = function(a, b) {
  var c = presentable.examples.pie.d3.append_impl.call(null, presentable.examples.pie.d3.selector__GT_name.call(null, cljs.core.first.call(null, a)), b), d = presentable.examples.pie.d3.handle_attrs.call(null, c, a);
  return cljs.core.reduce.call(null, function(a, b) {
    return cljs.core.vector_QMARK_.call(null, b) ? presentable.examples.pie.d3.append_impl.call(null, b, c) : presentable.examples.pie.d3.text.call(null, c, b)
  }, c, d)
};
String.prototype.presentable$examples$pie$d3$Append$ = !0;
String.prototype.presentable$examples$pie$d3$Append$append_impl$arity$2 = function(a, b) {
  return b.append(a)
};
presentable.examples.pie.d3.append = function(a, b) {
  return presentable.examples.pie.d3.append_impl.call(null, presentable.examples.pie.d3.selector__GT_name.call(null, b), a)
};
presentable.examples.pie.d3.data = function() {
  var a = null, a = function(a, c, d) {
    switch(arguments.length) {
      case 2:
        return a.data(c);
...
presentable.examples.pie.d3.datum = function() {
  var a = null, b = function(a) {
    return a.datum()
  }, a = function(a, d) {
    switch(arguments.length) {
...
presentable.examples.pie.d3.entered = function(a) {
  return a.enter()
};
presentable.examples.pie.d3.exited = function(a) {
  return a.exit()
};
presentable.examples.pie.d3.each = function(a, b) {
  return a.each(b)
};
presentable.examples.pie.d3.call = function() {
  var a = function(a, b, e) {
    return a.call(function(a) {
      return cljs.core.apply.call(null, b, a, e)
    })
  }, b = function(b, d, e) {
    var f = null;
    2 < arguments.length && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
...
presentable.examples.pie.d3.on = function(a, b, c) {
  return a.on(cljs.core.name.call(null, b), c)
};
presentable.examples.pie.d3.transition = function(a) {
  return a.transition()
};
presentable.examples.pie.d3.duration = function(a, b) {
  return a.duration(b)
};
presentable.examples.pie.d3.delay = function(a, b) {
  return a.delay(b)
};
presentable.examples.pie.d3.__GT_name = function(a) {
  return cljs.core.keyword_QMARK_.call(null, a) ? cljs.core.name.call(null, a) : a
};
presentable.examples.pie.d3.ease = function() {
  var a = function(a, b, e) {
    return a.ease(cljs.core.apply.call(null, d3.ease, cljs.core.name.call(null, b), cljs.core.map.call(null, presentable.examples.pie.d3.__GT_name, e)))
  }, b = function(b, d, e) {
    var f = null;
    2 < arguments.length && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
    return a.call(this, b, d, f)
...
presentable.core = {};
presentable.core.application = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
presentable.core.current_id = cljs.core.atom.call(null, 0);
presentable.core.extend_app = function(a, b, c) {
  return cljs.core.swap_BANG_.call(null, presentable.core.application, cljs.core.assoc_in, cljs.core.PersistentVector.fromArray([a, cljs.core.get.call(null, c, b)], !0), c)
};
presentable.core.next_id = function() {
  var a = cljs.core.deref.call(null, presentable.core.current_id);
  cljs.core.swap_BANG_.call(null, presentable.core.current_id, cljs.core.inc);
  return a
};
presentable.core.fetch = function(a, b) {
  return cljs.core.get_in.call(null, cljs.core.deref.call(null, presentable.core.application), cljs.core.PersistentVector.fromArray([a, b], !0))
};
presentable.core.property = function(a, b) {
  return cljs.core.get_in.call(null, cljs.core.deref.call(null, presentable.core.application), cljs.core.PersistentVector.fromArray(["\ufdd0:instances", a, b], !0))
};
presentable.core.__GT_instance = function(a) {
  return presentable.core.fetch.call(null, "\ufdd0:instances", a)
};
presentable.core.__GT_id = function(a) {
  return cljs.core.map_QMARK_.call(null, a) ? (new cljs.core.Keyword("\ufdd0:id")).call(null, a) : a
};
presentable.core.type_of = function(a) {
  return presentable.core.property.call(null, presentable.core.__GT_id.call(null, a), "\ufdd0:type")
};
presentable.core.view_of = function(a) {
  return presentable.core.property.call(null, presentable.core.__GT_id.call(null, a), "\ufdd0:view")
};
presentable.core.__GT_type = function(a, b) {
  return cljs.core.map.call(null, cljs.core.partial.call(null, presentable.core.fetch, a), cljs.core.get.call(null, b, a))
};
presentable.core.__GT_behaviors = function(a) {
  return presentable.core.__GT_type.call(null, "\ufdd0:behaviors", a)
};
presentable.core.make_type = function(a, b) {
  return cljs.core.assoc.call(null, cljs.core.apply.call(null, cljs.core.hash_map, b), "\ufdd0:type", a)
};
presentable.core.make_instance = function(a, b, c) {
  c = cljs.core.apply.call(null, cljs.core.hash_map, c);
  return cljs.core.assoc.call(null, cljs.core.merge.call(null, cljs.core.update_in.call(null, a, cljs.core.PersistentVector.fromArray(["\ufdd0:behaviors"], !0), cljs.core.concat, (new cljs.core.Keyword("\ufdd0:behaviors")).call(null, c)), cljs.core.dissoc.call(null, c, "\ufdd0:behaviors")), "\ufdd0:id", b)
};
presentable.core.behavior = function() {
  var a = function(a, b) {
    return presentable.core.extend_app.call(null, "\ufdd0:behaviors", "\ufdd0:type", presentable.core.make_type.call(null, a, b))
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e)
...
presentable.core.presenter = function() {
  var a = function(a, b) {
    return presentable.core.extend_app.call(null, "\ufdd0:presenters", "\ufdd0:type", presentable.core.make_type.call(null, a, b))
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e)
...
presentable.core.assemble = function(a) {
  a = (new cljs.core.Keyword("\ufdd0:factory")).call(null, a).call(null, a);
  return cljs.core.vector_QMARK_.call(null, a) ? crate.core.html.call(null, a) : a
};
presentable.core.trigger_dom = function(a, b, c) {
  return jQuery.prototype.trigger.apply(jayq.core.$.call(null, a), cljs.core.into_array.call(null, cljs.core.cons.call(null, cljs.core.name.call(null, b), c)))
};
presentable.core.raise_BANG_ = function() {
  var a = function(a, b, e) {
    return presentable.core.trigger_dom.call(null, presentable.core.view_of.call(null, a), b, e)
  }, b = function(b, d, e) {
    var f = null;
    2 < arguments.length && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
    return a.call(this, b, d, f)
...
presentable.core.dom__GT_botid = function(a) {
  a: {
    for(a = jayq.core.$.call(null, a);;) {
      var b = jayq.core.attr.call(null, a, "\ufdd0:presenter");
      if(cljs.core.truth_(b)) {
        a = b;
        break a
      }else {
        a = jayq.core.parent.call(null, a)
      }
    }
    a = void 0
  }
...
presentable.core.trigger_BANG_ = function() {
  var a = function(a, b, e) {
    for(var a = presentable.core.__GT_instance.call(null, presentable.core.__GT_id.call(null, a)), f = cljs.core.seq.call(null, presentable.core.__GT_behaviors.call(null, a)), g = null, h = 0, i = 0;;) {
      if(i < h) {
        var j = cljs.core._nth.call(null, g, i);
        cljs.core.contains_QMARK_.call(null, cljs.core.set.call(null, (new cljs.core.Keyword("\ufdd0:triggers")).call(null, j)), b) && (j = (new cljs.core.Keyword("\ufdd0:reaction")).call(null, j), cljs.core.truth_(j) && cljs.core.apply.call(null, j, a, e));
        i += 1
      }else {
        if(f = cljs.core.seq.call(null, f)) {
          cljs.core.chunked_seq_QMARK_.call(null, f) ? (h = cljs.core.chunk_first.call(null, f), f = cljs.core.chunk_rest.call(null, f), g = h, h = cljs.core.count.call(null, h)) : (j = cljs.core.first.call(null, f), cljs.core.contains_QMARK_.call(null, cljs.core.set.call(null, (new cljs.core.Keyword("\ufdd0:triggers")).call(null, j)), b) && (g = (new cljs.core.Keyword("\ufdd0:reaction")).call(null, j), cljs.core.truth_(g) && cljs.core.apply.call(null, g, a, e)), f = cljs.core.next.call(null, f), 
          g = null, h = 0), i = 0
        }else {
          return null
        }
...
presentable.core.changes__GT_triggers = function(a) {
  return cljs.core.map.call(null, function(a) {
    return cljs.core.keyword.call(null, [cljs.core.str("update."), cljs.core.str(cljs.core.name.call(null, a))].join(""))
  }, a)
};
presentable.core.triggers_on_QMARK_ = function(a, b) {
  return cljs.core.some.call(null, cljs.core.set.call(null, (new cljs.core.Keyword("\ufdd0:triggers")).call(null, a)), b)
};
presentable.core.trigger_change_BANG_ = function(a, b, c) {
  for(var a = presentable.core.__GT_instance.call(null, a), b = presentable.core.changes__GT_triggers.call(null, c), d = cljs.core.seq.call(null, presentable.core.__GT_behaviors.call(null, a)), e = null, f = 0, g = 0;;) {
    if(g < f) {
      var h = cljs.core._nth.call(null, e, g);
      cljs.core.truth_(presentable.core.triggers_on_QMARK_.call(null, h, b)) && (h = (new cljs.core.Keyword("\ufdd0:reaction")).call(null, h), cljs.core.truth_(h) && h.call(null, a, c));
      g += 1
    }else {
      if(d = cljs.core.seq.call(null, d)) {
        cljs.core.chunked_seq_QMARK_.call(null, d) ? (f = cljs.core.chunk_first.call(null, d), d = cljs.core.chunk_rest.call(null, d), e = f, f = cljs.core.count.call(null, f)) : (h = cljs.core.first.call(null, d), cljs.core.truth_(presentable.core.triggers_on_QMARK_.call(null, h, b)) && (e = (new cljs.core.Keyword("\ufdd0:reaction")).call(null, h), cljs.core.truth_(e) && e.call(null, a, c)), d = cljs.core.next.call(null, d), e = null, f = 0), g = 0
      }else {
        return null
      }
    }
...
presentable.core.target_type = function(a) {
  return(new cljs.core.Keyword("\ufdd0:type")).call(null, presentable.core.__GT_instance.call(null, presentable.core.dom__GT_botid.call(null, a.target)))
};
presentable.core.fill_in_type = function(a, b) {
  return cljs.core.empty_QMARK_.call(null, a) ? presentable.core.type_of.call(null, b) : cljs.core.keyword.call(null, a)
};
presentable.core.event_handler = function(a, b, c) {
  var d = function(d, e) {
    return cljs.core._EQ_.call(null, presentable.core.target_type.call(null, d), presentable.core.fill_in_type.call(null, b, c)) ? cljs.core.apply.call(null, presentable.core.trigger_BANG_, c, a, d, e) : null
  }, e = function(a, b) {
    var c = null;
...
presentable.core.register_trigger = function(a, b, c) {
  var d = clojure.string.split.call(null, cljs.core.name.call(null, a), /\./), e = cljs.core.nth.call(null, d, 0, null), d = cljs.core.nth.call(null, d, 1, null);
  return jayq.core.on.call(null, c, d, presentable.core.event_handler.call(null, a, e, b))
};
presentable.core.register_triggers = function(a, b) {
  for(var c = cljs.core.seq.call(null, (new cljs.core.Keyword("\ufdd0:triggers")).call(null, b)), d = null, e = 0, f = 0;;) {
    if(f < e) {
      var g = cljs.core._nth.call(null, d, f);
      presentable.core.register_trigger.call(null, g, (new cljs.core.Keyword("\ufdd0:id")).call(null, b), a);
      f += 1
    }else {
      if(c = cljs.core.seq.call(null, c)) {
        d = c, cljs.core.chunked_seq_QMARK_.call(null, d) ? (c = cljs.core.chunk_first.call(null, d), e = cljs.core.chunk_rest.call(null, d), d = c, g = cljs.core.count.call(null, c), c = e, e = g) : (g = cljs.core.first.call(null, d), presentable.core.register_trigger.call(null, g, (new cljs.core.Keyword("\ufdd0:id")).call(null, b), a), c = cljs.core.next.call(null, d), d = null, e = 0), f = 0
      }else {
        return null
      }
    }
...
presentable.core.make = function() {
  var a = function(a, b) {
    var e = presentable.core.fetch.call(null, "\ufdd0:presenters", a);
    if(cljs.core.truth_(e)) {
      var f = presentable.core.next_id.call(null), e = presentable.core.make_instance.call(null, e, f, b), g = presentable.core.assemble.call(null, e), h = cljs.core.assoc.call(null, e, "\ufdd0:view", g), g = jayq.core.$.call(null, g);
      jayq.core.attr.call(null, g, "\ufdd0:presenter", f);
      presentable.core.register_triggers.call(null, g, e);
      presentable.core.extend_app.call(null, "\ufdd0:instances", "\ufdd0:id", h);
      presentable.core.trigger_BANG_.call(null, f, "\ufdd0:init", null);
      return f
    }
    return null
  }, b = function(b, d) {
...
presentable.core.update_behaviors = function() {
  var a = function(a, b, e) {
    a = presentable.core.__GT_id.call(null, a);
    return cljs.core.swap_BANG_.call(null, presentable.core.application, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0:instances", a, "\ufdd0:behaviors"], !0), b, e)
  }, b = function(b, d, e) {
    var f = null;
    2 < arguments.length && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
    return a.call(this, b, d, f)
...
presentable.core.add_behaviors_BANG_ = function() {
  var a = function(a, b) {
    return cljs.core.apply.call(null, presentable.core.update_behaviors, a, cljs.core.concat, b)
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e)
...
presentable.core.rem_behaviors_BANG_ = function() {
  var a = function(a, b) {
    var e = cljs.core.set.call(null, b);
    return cljs.core.apply.call(null, presentable.core.update_behaviors, a, cljs.core.partial.call(null, cljs.core.remove, e))
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
    return a.call(this, b, e)
...
presentable.core._BANG_ = function() {
  var a = function(a, b) {
    var e = presentable.core.__GT_id.call(null, a), f = cljs.core.apply.call(null, cljs.core.hash_map, b);
    cljs.core.swap_BANG_.call(null, presentable.core.application, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0:instances", e], !0), cljs.core.merge, f);
    presentable.core.trigger_change_BANG_.call(null, e, "\ufdd0:update", cljs.core.keys.call(null, f));
    return a
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
...
presentable.core.update_BANG_ = function() {
  var a = function(a, b, e, f) {
    return presentable.core._BANG_.call(null, a, b, cljs.core.apply.call(null, e, presentable.core.property.call(null, presentable.core.__GT_id.call(null, a), b), f))
  }, b = function(b, d, e, f) {
    var g = null;
...
presentable.examples.pie.views.d3_pie_chart = function(a) {
  ...
  presentable.examples.pie.d3.css.call(null, presentable.examples.pie.d3.append.call(null, presentable.examples.pie.d3.entered.call(null, presentable.examples.pie.d3.data.call(null, presentable.examples.pie.d3.select_STAR_.call(null, presentable.examples.pie.d3.append.call(null, presentable.examples.pie.d3.select.call(null, b), presentable.examples.pie.views.root), "\ufdd0:.arc"), presentable.examples.pie.views.pie.call(null, cljs.core.vals.call(null, a)))), presentable.examples.pie.views.pie_arc), 
  "\ufdd0:fill", function(a, b) {
    return presentable.examples.pie.views.color.call(null, b)
  });
  return b
};
presentable.examples.pie.views.update_pies = function(a) {
  return presentable.examples.pie.d3.append.call(null, presentable.examples.pie.d3.entered.call(null, presentable.examples.pie.d3.data.call(null, presentable.examples.pie.d3.select_STAR_.call(null, presentable.examples.pie.d3.select.call(null, presentable.core.view_of.call(null, a)), "\ufdd0:.pie"), cljs.core.into_array.call(null, (new cljs.core.Keyword("\ufdd0:children")).call(null, a)))), presentable.core.view_of)
};
...
tbn.events._on = function(a, b, c) {
  var d;
  d = a ? a.tbn$events$IObservable$_on$arity$3 : a;
  if(d) {
    return a.tbn$events$IObservable$_on$arity$3(a, b, c)
  }
  d = tbn.events._on[goog.typeOf(null == a ? null : a)];
  if(!d && (d = tbn.events._on._, !d)) {
    throw cljs.core.missing_protocol.call(null, "IObservable.-on", a);
  }
  return d.call(null, a, b, c)
};
tbn.events._off = function(a, b, c) {
  var d;
  d = a ? a.tbn$events$IObservable$_off$arity$3 : a;
  if(d) {
    return a.tbn$events$IObservable$_off$arity$3(a, b, c)
  }
  d = tbn.events._off[goog.typeOf(null == a ? null : a)];
  if(!d && (d = tbn.events._off._, !d)) {
    throw cljs.core.missing_protocol.call(null, "IObservable.-off", a);
  }
  return d.call(null, a, b, c)
};
tbn.events._trigger = function(a, b, c) {
  var d;
  d = a ? a.tbn$events$IObservable$_trigger$arity$3 : a;
  if(d) {
    return a.tbn$events$IObservable$_trigger$arity$3(a, b, c)
  }
  d = tbn.events._trigger[goog.typeOf(null == a ? null : a)];
  if(!d && (d = tbn.events._trigger._, !d)) {
    throw cljs.core.missing_protocol.call(null, "IObservable.-trigger", a);
  }
  return d.call(null, a, b, c)
};
tbn.events.IObserver = {};
tbn.events._event = function(a, b) {
  var c;
  c = a ? a.tbn$events$IObserver$_event$arity$2 : a;
  if(c) {
    return a.tbn$events$IObserver$_event$arity$2(a, b)
  }
  c = tbn.events._event[goog.typeOf(null == a ? null : a)];
  if(!c && (c = tbn.events._event._, !c)) {
    throw cljs.core.missing_protocol.call(null, "IObserver.-event", a);
  }
  return c.call(null, a, b)
};
Function.prototype.tbn$events$IObserver$ = !0;
Function.prototype.tbn$events$IObserver$_event$arity$2 = function(a, b) {
  return cljs.core.apply.call(null, a, b)
};
tbn.events.add_to_channel = function(a, b, c) {
  return cljs.core.update_in.call(null, a, cljs.core.PersistentVector.fromArray([b], !0), cljs.core.conj, c)
};
tbn.events.AddToChannel = {};
tbn.events._add_BANG_ = function(a, b, c) {
  var d;
  d = a ? a.tbn$events$AddToChannel$_add_BANG_$arity$3 : a;
  if(d) {
    return a.tbn$events$AddToChannel$_add_BANG_$arity$3(a, b, c)
  }
  d = tbn.events._add_BANG_[goog.typeOf(null == a ? null : a)];
  if(!d && (d = tbn.events._add_BANG_._, !d)) {
    throw cljs.core.missing_protocol.call(null, "AddToChannel.-add!", a);
  }
  return d.call(null, a, b, c)
};
String.prototype.tbn$events$AddToChannel$ = !0;
String.prototype.tbn$events$AddToChannel$_add_BANG_$arity$3 = function(a, b, c) {
  return cljs.core.swap_BANG_.call(null, b, tbn.events.add_to_channel, cljs.core._EQ_.call(null, a, "\ufdd0:all") ? new cljs.core.Symbol(null, "_", "_", -1640531432, null) : a, c)
};
cljs.core.PersistentVector.prototype.tbn$events$AddToChannel$ = !0;
cljs.core.PersistentVector.prototype.tbn$events$AddToChannel$_add_BANG_$arity$3 = function(a, b, c) {
  return cljs.core.swap_BANG_.call(null, b, function(a) {
    return cljs.core.map.call(null, function(b) {
      return tbn.events.add_to_channel.call(null, a, cljs.core.key.call(null, b), c)
    }, cljs.core.keys.call(null, a))
  })
};
tbn.events.Channels = function(a) {
  this.listeners = a
};
tbn.events.Channels.cljs$lang$type = !0;
tbn.events.Channels.cljs$lang$ctorStr = "tbn.events/Channels";
tbn.events.Channels.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "tbn.events/Channels")
};
tbn.events.Channels.prototype.tbn$events$IObservable$ = !0;
tbn.events.Channels.prototype.tbn$events$IObservable$_on$arity$3 = function(a, b, c) {
  return tbn.events._add_BANG_.call(null, b, this.listeners, c)
};
tbn.events.Channels.prototype.tbn$events$IObservable$_trigger$arity$3 = function(a, b, c) {
  for(var a = cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.get.call(null, cljs.core.deref.call(null, this.listeners), b), cljs.core.get.call(null, cljs.core.deref.call(null, this.listeners), new cljs.core.Symbol(null, "_", "_", -1640531432, null)))), b = null, d = 0, e = 0;;) {
    if(e < d) {
      var f = cljs.core._nth.call(null, b, e);
      tbn.events._event.call(null, f, c);
      e += 1
    }else {
      if(a = cljs.core.seq.call(null, a)) {
        b = a, cljs.core.chunked_seq_QMARK_.call(null, b) ? (a = cljs.core.chunk_first.call(null, b), d = cljs.core.chunk_rest.call(null, b), b = a, f = cljs.core.count.call(null, a), a = d, d = f) : (f = cljs.core.first.call(null, b), tbn.events._event.call(null, f, c), a = cljs.core.next.call(null, b), b = null, d = 0), e = 0
      }else {
        return null
      }
    }
...
tbn.events.channels = function() {
  return new tbn.events.Channels(cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY))
};
tbn.events.on = function() {
  var a = null, b = function(a, b) {
    return tbn.events._on.call(null, a, "\ufdd0:all", b)
  }, c = function(a, b, c) {
    return tbn.events._on.call(null, a, b, c)
  }, a = function(a, e, f) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, e);
...
tbn.events.trigger = function() {
  var a = function(a, b, e) {
    return tbn.events._trigger.call(null, a, b, e)
  }, b = function(b, d, e) {
    var f = null;
    2 < arguments.length && (f = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0));
    return a.call(this, b, d, f)
...
tbn.model.Model.cljs$lang$type = !0;
tbn.model.Model.cljs$lang$ctorStr = "tbn.model/Model";
tbn.model.Model.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "tbn.model/Model")
};
tbn.model.Model.prototype.cljs$core$IDeref$_deref$arity$1 = function() {
  return cljs.core.deref.call(null, this.local)
};
tbn.model.Model.prototype.tbn$events$IObservable$ = !0;
tbn.model.Model.prototype.tbn$events$IObservable$_on$arity$3 = function(a, b, c) {
  return tbn.events.on.call(null, this.channels, b, c)
};
tbn.model.Model.prototype.tbn$mutable$IMMap$ = !0;
tbn.model.Model.prototype.tbn$mutable$IMMap$_dissoc_BANG_$arity$2 = function(a, b) {
  return a.tbn$mutable$IMUpdate$_update_BANG_$arity$2(a, cljs.core.PersistentVector.fromArray(["\ufdd0:dissoc", b], !0))
};
tbn.model.Model.prototype.tbn$mutable$IMAssociative$ = !0;
tbn.model.Model.prototype.tbn$mutable$IMAssociative$_assoc_BANG_$arity$3 = function(a, b, c) {
  return a.tbn$mutable$IMUpdate$_update_BANG_$arity$2(a, cljs.core.PersistentVector.fromArray(["\ufdd0:assoc", b, c], !0))
};
tbn.model.Model.prototype.tbn$mutable$IMSetable$ = !0;
tbn.model.Model.prototype.tbn$mutable$IMSetable$_reset_BANG_$arity$2 = function(a, b) {
  return a.tbn$mutable$IMUpdate$_update_BANG_$arity$2(a, cljs.core.PersistentVector.fromArray(["\ufdd0:set", b], !0))
};
tbn.model.Model.prototype.tbn$mutable$IMUpdate$ = !0;
tbn.model.Model.prototype.tbn$mutable$IMUpdate$_update_BANG_$arity$2 = function(a, b) {
  var c = this;
...
tbn.model.make = function(a, b, c) {
  return new tbn.model.Model(cljs.core.atom.call(null, c), a, b, tbn.events.channels.call(null))
};
tbn.collection = {};
cljs.core.Atom.prototype.tbn$events$IObservable$ = !0;
cljs.core.Atom.prototype.tbn$events$IObservable$_on$arity$3 = function(a, b, c) {
  return tbn.events.on.call(null, (new cljs.core.Keyword("\ufdd0:channels")).call(null, cljs.core.meta.call(null, cljs.core.deref.call(null, a))), b, c)
};
cljs.core.Atom.prototype.tbn$events$IObservable$_trigger$arity$3 = function(a, b, c) {
  return tbn.events._trigger.call(null, (new cljs.core.Keyword("\ufdd0:channels")).call(null, cljs.core.meta.call(null, cljs.core.deref.call(null, a))), b, c)
};
cljs.core.Atom.prototype.cljs$core$ICounted$ = !0;
cljs.core.Atom.prototype.cljs$core$ICounted$_count$arity$1 = function(a) {
  return cljs.core._count.call(null, cljs.core.deref.call(null, a))
};
cljs.core.Atom.prototype.cljs$core$IIndexed$ = !0;
cljs.core.Atom.prototype.cljs$core$IIndexed$_nth$arity$2 = function(a, b) {
  return cljs.core.nth.call(null, cljs.core.deref.call(null, a), b)
};
cljs.core.Atom.prototype.tbn$mutable$IMStack$ = !0;
cljs.core.Atom.prototype.tbn$mutable$IMStack$_pop_BANG_$arity$1 = function(a) {
  var b = cljs.core.last.call(null, cljs.core.deref.call(null, a));
  cljs.core.swap_BANG_.call(null, a, cljs.core.pop);
  return tbn.events.trigger.call(null, (new cljs.core.Keyword("\ufdd0:channels")).call(null, cljs.core.meta.call(null, cljs.core.deref.call(null, a))), "\ufdd0:removed", b)
};
cljs.core.Atom.prototype.tbn$mutable$IMCollection$ = !0;
cljs.core.Atom.prototype.tbn$mutable$IMCollection$_conj_BANG_$arity$2 = function(a, b) {
  cljs.core.swap_BANG_.call(null, a, cljs.core.conj, b);
  return tbn.events.trigger.call(null, (new cljs.core.Keyword("\ufdd0:channels")).call(null, cljs.core.meta.call(null, cljs.core.deref.call(null, a))), "\ufdd0:added", b)
};
tbn.collection.StoredCollection = function(a, b, c) {
  this.local = a;
  this.store = b;
  this.uri = c;
  this.cljs$lang$protocol_mask$partition1$ = 0;
...
tbn.collection.StoredCollection.cljs$lang$type = !0;
tbn.collection.StoredCollection.cljs$lang$ctorStr = "tbn.collection/StoredCollection";
tbn.collection.StoredCollection.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "tbn.collection/StoredCollection")
};
tbn.collection.StoredCollection.prototype.tbn$events$IObservable$ = !0;
tbn.collection.StoredCollection.prototype.tbn$events$IObservable$_on$arity$3 = function(a, b, c) {
  return tbn.events.on.call(null, this.local, b, c)
};
tbn.collection.StoredCollection.prototype.cljs$core$ICounted$_count$arity$1 = function() {
  return cljs.core._count.call(null, this.local)
};
tbn.collection.StoredCollection.prototype.cljs$core$IIndexed$_nth$arity$2 = function(a, b) {
  return cljs.core._nth.call(null, this.local, b)
};
tbn.collection.StoredCollection.prototype.tbn$mutable$IMStack$ = !0;
tbn.collection.StoredCollection.prototype.tbn$mutable$IMStack$_pop_BANG_$arity$1 = function() {
  var a = this;
  return tbn.store.delete_BANG_.call(null, a.store, a.uri, (new cljs.core.Keyword("\ufdd0:_id")).call(null, cljs.core.deref.call(null, cljs.core.last.call(null, cljs.core.deref.call(null, a.local)))), function(b) {
    return cljs.core.truth_(b) ? tbn.events.trigger.call(null, a.local, "\ufdd0:error", b) : tbn.mutable._pop_BANG_.call(null, a.local)
  })
};
tbn.collection.StoredCollection.prototype.tbn$mutable$IMCollection$ = !0;
tbn.collection.StoredCollection.prototype.tbn$mutable$IMCollection$_conj_BANG_$arity$2 = function(a, b) {
  var c = this;
  return tbn.store.create_BANG_.call(null, c.store, c.uri, b, function(a, b) {
    return cljs.core.truth_(a) ? tbn.events.trigger.call(null, c.local, "\ufdd0:error", a) : tbn.mutable._conj_BANG_.call(null, c.local, tbn.model.make.call(null, c.store, c.uri, b))
  })
};
tbn.collection.cached = function() {
  return cljs.core.atom.call(null, cljs.core.vary_meta.call(null, cljs.core.PersistentVector.EMPTY, cljs.core.assoc, "\ufdd0:channels", tbn.events.channels.call(null)))
};
tbn.collection.stored = function(a, b, c) {
  return new tbn.collection.StoredCollection(a, b, c)
};
tbn.store.memory = {};
tbn.store.memory.next_id = function(a) {
  return(new cljs.core.Keyword("\ufdd0:id")).call(null, cljs.core.swap_BANG_.call(null, a, cljs.core.update_in, cljs.core.PersistentVector.fromArray(["\ufdd0:id"], !0), cljs.core.inc))
};
tbn.store.memory.__GT_models = function(a, b) {
  return cljs.core.sort_by.call(null, cljs.core.key, cljs.core.get_in.call(null, cljs.core.deref.call(null, a), cljs.core.PersistentVector.fromArray(["\ufdd0:store", b], !0)))
};
cljs.core.Atom.prototype.tbn$store$IStore$ = !0;
cljs.core.Atom.prototype.tbn$store$IStore$_create_BANG_$arity$4 = function(a, b, c, d) {
  var e = tbn.store.memory.next_id.call(null, a), c = cljs.core.assoc.call(null, c, "\ufdd0:_id", e);
  cljs.core.swap_BANG_.call(null, a, cljs.core.assoc_in, cljs.core.PersistentVector.fromArray(["\ufdd0:store", b, e], !0), c);
  d.call(null, null, c);
  return a
};
cljs.core.Atom.prototype.tbn$store$IStore$_update_BANG_$arity$5 = function(a, b, c, d, e) {
  b = cljs.core.vector.call(null, "\ufdd0:store", b, c);
  d = tbn.commands.cmd__GT_fn.call(null, d);
  cljs.core.truth_(cljs.core.get_in.call(null, cljs.core.deref.call(null, a), b)) ? (d = cljs.core.swap_BANG_.call(null, a, cljs.core.update_in, b, d), e.call(null, null, cljs.core.get_in.call(null, d, b))) : e.call(null, Error("Model", "" + cljs.core.str(b), "does not exist"));
  return a
};
cljs.core.Atom.prototype.tbn$store$IStore$_delete_BANG_$arity$4 = function(a, b, c, d) {
  b = cljs.core.vector.call(null, "\ufdd0:store", b);
  cljs.core.contains_QMARK_.call(null, cljs.core.get_in.call(null, cljs.core.deref.call(null, a), b), c) ? (cljs.core.swap_BANG_.call(null, a, cljs.core.update_in, b, cljs.core.dissoc, c), d.call(null, null)) : d.call(null, Error("Model", "" + cljs.core.str(b), "does not exist"));
  return a
};
cljs.core.Atom.prototype.tbn$store$IStore$_collection$arity$2 = function(a, b) {
  var c = tbn.collection.cached.call(null);
  setTimeout(function() {
    for(var d = cljs.core.seq.call(null, tbn.store.memory.__GT_models.call(null, a, b)), e = null, f = 0, g = 0;;) {
      if(g < f) {
        var h = cljs.core._nth.call(null, e, g);
        tbn.mutable.conj_BANG_.call(null, c, cljs.core.val.call(null, h));
        g += 1
      }else {
        if(d = cljs.core.seq.call(null, d)) {
          e = d, cljs.core.chunked_seq_QMARK_.call(null, e) ? (d = cljs.core.chunk_first.call(null, e), g = cljs.core.chunk_rest.call(null, e), e = d, f = cljs.core.count.call(null, d), d = g) : (d = cljs.core.first.call(null, e), tbn.mutable.conj_BANG_.call(null, c, cljs.core.val.call(null, d)), d = cljs.core.next.call(null, e), e = null, f = 0), g = 0
        }else {
          break
        }
      }
    }
    return tbn.events.trigger.call(null, c, "\ufdd0:reset")
  }, 0);
  return tbn.collection.stored.call(null, c, a, b)
};
tbn.store.memory.make = function() {
  return cljs.core.atom.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:store", cljs.core.ObjMap.EMPTY, "\ufdd0:id", 0], !0))
};
...
presentable.core.presenter.call(null, "\ufdd0:pie", "\ufdd0:triggers", cljs.core.PersistentVector.fromArray(["\ufdd0:.changed"], !0), "\ufdd0:behaviors", cljs.core.PersistentVector.fromArray(["\ufdd0:model", "\ufdd0:update-pie"], !0), "\ufdd0:factory", function(a) {
  return presentable.examples.pie.views.d3_pie_chart.call(null, (new cljs.core.Keyword("\ufdd0:data")).call(null, cljs.core.deref.call(null, (new cljs.core.Keyword("\ufdd0:model")).call(null, a))))
});
...
presentable.examples.pie.init = function() {
  return jayq.core.append.call(null, jayq.core.$.call(null, "\ufdd0:#content"), presentable.core.view_of.call(null, presentable.examples.pie.the_app))
};
goog.exportSymbol("presentable.examples.pie.init", presentable.examples.pie.init);
