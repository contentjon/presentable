...
presentable.core.trigger_BANG_ = function() {
  var a = function(a, b, e) {
    for(var a = presentable.core.__GT_instance.call(null, presentable.core.__GT_id.call(null, a)), f = cljs.core.seq.call(null, (new cljs.core.Keyword("\ufdd0:behaviors")).call(null, a)), g = null, h = 0, i = 0;;) {
      if(i < h) {
        var j = cljs.core._nth.call(null, g, i), k = presentable.core.fetch.call(null, "\ufdd0:behaviors", j);
        if(cljs.core.truth_(k)) {
          j = k, cljs.core.contains_QMARK_.call(null, cljs.core.set.call(null, (new cljs.core.Keyword("\ufdd0:triggers")).call(null, j)), b) && (j = (new cljs.core.Keyword("\ufdd0:reaction")).call(null, j), cljs.core.truth_(j) && cljs.core.apply.call(null, j, a, e))
        }else {
          throw Error([cljs.core.str("Can't resolve behavior "), cljs.core.str(j), cljs.core.str(" referenced by "), cljs.core.str((new cljs.core.Keyword("\ufdd0:type")).call(null, a))].join(""));
        }
        i += 1
      }else {
        if(f = cljs.core.seq.call(null, f)) {
          if(cljs.core.chunked_seq_QMARK_.call(null, f)) {
            h = cljs.core.chunk_first.call(null, f), f = cljs.core.chunk_rest.call(null, f), g = h, h = cljs.core.count.call(null, h)
          }else {
            j = cljs.core.first.call(null, f);
            g = presentable.core.fetch.call(null, "\ufdd0:behaviors", j);
            if(cljs.core.truth_(g)) {
              cljs.core.contains_QMARK_.call(null, cljs.core.set.call(null, (new cljs.core.Keyword("\ufdd0:triggers")).call(null, g)), b) && (g = (new cljs.core.Keyword("\ufdd0:reaction")).call(null, g), cljs.core.truth_(g) && cljs.core.apply.call(null, g, a, e))
            }else {
              throw Error([cljs.core.str("Can't resolve behavior "), cljs.core.str(j), cljs.core.str(" referenced by "), cljs.core.str((new cljs.core.Keyword("\ufdd0:type")).call(null, a))].join(""));
            }
